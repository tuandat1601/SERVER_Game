import{t as h}from"./data-eba8857e.js";import{k as s,Y as l,m as d,b6 as r,aG as m}from"./index-bd88d923.js";function C(){const e=s([]),a=s(!0),i=[{label:"日期",prop:"date"},{label:"姓名",prop:"name"},{label:"地址",prop:"address"}],n=l({pageSize:20,currentPage:1,pageSizes:[20,40,60],total:0,align:"right",background:!0,small:!1}),o=l({text:"正在加载第一页...",viewBox:"-10, -10, 50, 50",spinner:`
        <path class="path" d="
          M 30 15
          L 28 17
          M 25.61 25.61
