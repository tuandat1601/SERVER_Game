/*
  ...
  - You are about to alter the column `paidAmount` on the `orders` table. The data in that column could be lost. The data in that column will be cast from `UnsignedInt` to `Double`.
...
-- AlterTable
ALTER TABLE `orders` MODIFY `paidAmount` DOUBLE NOT NULL,
