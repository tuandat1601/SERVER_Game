...
*/
-- DropIndex
DROP INDEX `game_code_used_code_gameId_used_roleId_idx` ON `game_code_used`;

-- DropIndex
DROP INDEX `game_comcode_used_code_idx` ON `game_comcode_used`;
...
-- CreateIndex
CREATE INDEX `game_code_used_code_gameId_roleId_codeinfoId_used_idx` ON `game_code_used`(`code`, `gameId`, `roleId`, `codeinfoId`, `used`);

-- CreateIndex
CREATE INDEX `game_comcode_used_code_gameId_roleId_codeinfoId_idx` ON `game_comcode_used`(`code`, `gameId`, `roleId`, `codeinfoId`);
