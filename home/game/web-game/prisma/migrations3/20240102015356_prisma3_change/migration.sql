...
-- AlterTable
ALTER TABLE `logins` MODIFY `gameUserId` VARCHAR(300) NOT NULL,
    MODIFY `channelToken` VARCHAR(2048) NOT NULL,
    MODIFY `updatedAt` TIMESTAMP(0) NOT NULL DEFAULT NOW() ON UPDATE NOW();

-- AlterTable
ALTER TABLE `orders` MODIFY `gameUserId` VARCHAR(300) NOT NULL,
    MODIFY `createdAt` DATETIME NOT NULL DEFAULT NOW(),
    MODIFY `updatedAt` TIMESTAMP(0) NOT NULL DEFAULT NOW() ON UPDATE NOW();

-- AlterTable
ALTER TABLE `qipa_active` MODIFY `item` VARCHAR(2048) NOT NULL;
