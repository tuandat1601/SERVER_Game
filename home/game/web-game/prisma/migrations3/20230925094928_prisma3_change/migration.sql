/*
  ...
  - Added the required column `gameId` to the `code_email_award` table without a default value. This is not possible if the table is not empty.
  - Added the required column `serverId` to the `code_email_award` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `code_email_award` ADD COLUMN `gameId` SMALLINT UNSIGNED NOT NULL,
    ADD COLUMN `serverId` MEDIUMINT UNSIGNED NOT NULL;
