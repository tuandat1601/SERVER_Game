/*
  ...
  - You are about to drop the column `RoleName` on the `orders` table. All the data in the column will be lost.
  ...
  - Added the required column `gameRoleName` to the `Orders` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `orders` DROP COLUMN `RoleName`,
    ADD COLUMN `gameRoleName` VARCHAR(18) NOT NULL,
