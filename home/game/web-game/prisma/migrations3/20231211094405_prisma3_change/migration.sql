...
-- AlterTable
ALTER TABLE `games` ADD COLUMN `info` JSON NOT NULL,
...
-- AlterTable
ALTER TABLE `servers` ADD COLUMN `chatIP` VARCHAR(191) NOT NULL DEFAULT '',
    MODIFY `openTime` DATETIME NOT NULL DEFAULT NOW(),
    MODIFY `createdAt` DATETIME NOT NULL DEFAULT NOW(),
    MODIFY `updatedAt` TIMESTAMP(0) NOT NULL DEFAULT NOW() ON UPDATE NOW();
