...
*/
-- DropIndex
DROP INDEX `game_code_used_code_gameId_idx` ON `game_code_used`;
...
-- CreateIndex
CREATE INDEX `game_code_used_code_gameId_used_roleId_idx` ON `game_code_used`(`code`, `gameId`, `used`, `roleId`);
