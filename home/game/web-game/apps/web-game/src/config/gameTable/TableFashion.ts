    ...
    export class TableFashion {
        static TableName: string = "Fashion";
        ...
        static initTable(){
            if (!TableFashion.table) {
                TableFashion.table = JsonUtil.get(TableFashion.TableName);
            }
        }
    
        static getTable(){
            return TableFashion.table
        }
    
        private init(id: number) {
            this.data = TableFashion.table[id];
            this.id = id;
        }
        ...
        static checkHave(id: number){
            if(TableFashion.table[id] == undefined){
                return false
            }
            return true
        }
        ...
        static getVal(id: number,key:any){
            ...
            if(TableFashion.table[id][key] == undefined){
                return
            }

            return TableFashion.table[id][key];
        }
